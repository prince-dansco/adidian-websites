...
import { Calendar, Phone, ArrowRight, Target, Eye, Heart, Users } from 'lucide-react';
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Adidian?</h2>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Take the first step towards a pain-free, active lifestyle. Our expert team is here to help you achieve your health goals.
          </p>
